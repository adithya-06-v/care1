          ...
          <AnimatePresence mode="wait">
            {isLogin && (
              <motion.div
                ...
                className="absolute right-0 top-0 w-1/2 h-full flex flex-col justify-center text-right px-10 pr-20"
              >
          ...
          <AnimatePresence mode="wait">
            {!isLogin && (
              <motion.div
                ...
                exit={{ x: -100, opacity: 0, filter: 'blur(10px)' }}
                transition={{ duration: 0.7, delay: 0.3 }}
                className="absolute left-0 top-0 w-1/2 h-full flex flex-col justify-center text-left px-10 pl-10"
              >
                <h2 className="text-4xl font-bold text-white uppercase leading-tight">
                  Welcome!
                </h2>
